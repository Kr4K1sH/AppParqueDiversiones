...
public class TiqueteBD {
    private String rutaArchivo = ".\\Archivos\\Tiquete.txt";
       private String rutaArchivoTemporal= ".\\Archivos\\TiqueteTemp.txt";
       ...
       private static  TiqueteBD oTiqueteBD= null;
       
       //Constructor privado, se implementa el patrón Singleton
       private TiqueteBD() {
           rutaArchivo = ".\\Archivos\\Tiquete.txt";
           rutaArchivoTemporal = ".\\Archivos\\TiqueteTemp.txt";
       ...
       public static TiqueteBD getInstance(){
           if(oTiqueteBD == null){
               oTiqueteBD = new TiqueteBD();
           }
           return oTiqueteBD;
       }
       ...
       */
        ...
        * @return ArrayList
        */
        public ArrayList listaDeTiquetes() throws Exception{
           ArrayList listaDeTiquete= new ArrayList();
           ...
           try {         
              ...
              //Si al leer del archivo no hay objeto sucede la excepción
               while(true){
                   Tiquete miTiquete = (Tiquete)oArchivoOIS.readObject();                  
                   listaDeTiquete.add(miTiquete);
               }
       ...
       public Tiquete consultarTiquete(String descripcion)throws Exception {
           Tiquete TiqueteBuscado= null ;
           try {
                oArchivoOIS = abrirArchivoInput(rutaArchivo);
                //Si va a leer y no hay objeto Departamento se va por el catch
                while(true){
                   TiqueteBuscado = (Tiquete)oArchivoOIS.readObject();
                   if (TiqueteBuscado.getDescripcion().equalsIgnoreCase(descripcion)) {
                       return TiqueteBuscado;
                   } else {
       ...
       private void pasarArchivoTemporal_ArchivoOriginal() {
          ...
          if(archivoTemp.exists()&& archivoOriginal.exists()){
            ...
            archivoTemp.renameTo(new File(".\\Archivos\\Tiquete.txt"));
          }      
       }  
